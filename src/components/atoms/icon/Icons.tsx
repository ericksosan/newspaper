...
export const MoonIcon = ({ className }: React.ComponentProps<'svg'>): JSX.Element => {
  return (
...
export const SunIcon = ({ className }: React.ComponentProps<'svg'>): JSX.Element => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
      fill="currentColor"
...
export const NewspaperIcon = ({ className }: React.ComponentProps<'svg'>): JSX.Element => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
      fill="currentColor"
...
export const PecilSquareIcon = ({ className }: React.ComponentProps<'svg'>): JSX.Element => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
      fill="currentColor"
...
export const GroupUsersIcon = ({ className }: React.ComponentProps<'svg'>): JSX.Element => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
      fill="currentColor"
...
export const ArrowRightRectangleIcon = ({ className }: React.ComponentProps<'svg'>): JSX.Element => {
  return (
    <svg
...
export const CheckBadgeIcon = ({ className }: React.ComponentProps<'svg'>): JSX.Element => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
      fill="currentColor"
...
export const UserPencilIcon = ({ className }: React.ComponentProps<'svg'>): JSX.Element => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="currentColor"
...
export const KeyIcon = ({ className }: React.ComponentProps<'svg'>): JSX.Element => {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="currentColor"
...
export const UserCircleIcon = ({ className }: React.ComponentProps<'svg'>): JSX.Element => {
  return (
...
export const ToothIcon = ({ className }: React.ComponentProps<'svg'>): JSX.Element => {
  return (
...
export const ArrowTopRightSquareIcon = ({ className }: React.ComponentProps<'svg'>): JSX.Element => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
...
export const EyeIcon = ({ className }: React.ComponentProps<'svg'>): JSX.Element => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
...
export const EyeSlashIcon = ({ className }: React.ComponentProps<'svg'>): JSX.Element => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
...
export const ErrorSignalIcon = (): JSX.Element => {
  return (
...
export const SuccessSignalIcon = (): JSX.Element => {
  return (
    <svg className="flex-shrink-0 inline w-4 h-4 mr-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
      <path d="M10 .5a9.5 9.5 0 1 0 9.5 9.5A9.51 9.51 0 0 0 10 .5ZM9.5 4a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3ZM12 15H8a1 1 0 0 1 0-2h1v-3H8a1 1 0 0 1 0-2h2a1 1 0 0 1 1 1v4h1a1 1 0 0 1 0 2Z" />
    </svg>
...
export const MarkdownIcon = ({ className }: React.ComponentProps<'svg'>): JSX.Element => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg"
      className={twMerge(
        'w-5 h-5',
...
export const ExclamationMarkIcon = ({ className }: React.ComponentProps<'svg'>): JSX.Element => {
  return (
    <svg
      className={twMerge(
        'w-12 h-12',
...
export const FacebookIcon = ({ className }: React.ComponentProps<'svg'>): JSX.Element => {
  return (
    <svg
      className={className}
      xmlns="http://www.w3.org/2000/svg"
...
export const WhatsappIcon = ({ className }: React.ComponentProps<'svg'>): JSX.Element => {
  return (
    <svg
      className={className}
      xmlns="http://www.w3.org/2000/svg"
...
export const XTwitterIcon = ({ className }: React.ComponentProps<'svg'>): JSX.Element => {
  return (
    <svg
      className={className}
      xmlns="http://www.w3.org/2000/svg"
...
export const LinkedInIcon = ({ className }: React.ComponentProps<'svg'>): JSX.Element => {
  return (
    <svg
      className={className}
      xmlns="http://www.w3.org/2000/svg"
...
export const TrashIcon = ({ className }: React.ComponentProps<'svg'>): JSX.Element => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg"
      className={twMerge(
        'w-5 h-5',
...
export const SaveIcon = ({ className }: React.ComponentProps<'svg'>): JSX.Element => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg"
      className={twMerge(
        'w-5 h-5',
...
export const WriteIcon = ({ className }: React.ComponentProps<'svg'>): JSX.Element => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      height="1em"
...
export const CameraIcon = ({ className }: React.ComponentProps<'svg'>): JSX.Element => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg"
      className={twMerge('w-6 h-6', className)}
      viewBox="0 0 24 24"
...
export const PhotoCicleIcon = ({ className }: React.ComponentProps<'svg'>): JSX.Element => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg"
      className={twMerge('w-6 h-6', className)}
      viewBox="0 0 24 24"
