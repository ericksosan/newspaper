  ...
  return (
    <div className="w-full min-h-screen pt-4 pb-10 flex flex-col gap-4">
      <div className='mx-auto max-w-4xl'>
        <div
          className="max-w-full prose dark:prose-invert prose-code:px-2 prose-code:py-1 prose-headings:font-montserrat
          prose-code:bg-slate-700 prose-code:rounded-md prose-img:rounded-md font-inter prose-p:text-justify"
